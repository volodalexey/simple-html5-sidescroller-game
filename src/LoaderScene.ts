  ...
  bundles: [
    {
      ...
      assets: {
        ...
        citySpritesheet: 'assets/spritesheets/city-spritesheet.json',
        forestSpritesheet: 'assets/spritesheets/forest-spritesheet.json'
      }
    }
  ]
}
...
export class LoaderScene extends Container implements IScene {
  ...
  public getAssets (): {
    ...
    citySpritesheet: Spritesheet
    forestSpritesheet: Spritesheet
  } {
    return {
      spritesheet: Assets.get('spritesheet'),
      citySpritesheet: Assets.get('citySpritesheet'),
      forestSpritesheet: Assets.get('forestSpritesheet')
    }
  }
